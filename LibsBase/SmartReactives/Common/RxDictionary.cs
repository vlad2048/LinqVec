...
namespace SmartReactives.Common
{
    ...
    /// </summary>
    public class RxDictionary<TKey, TValue> : DefaultDictionary<TKey, TValue>
    {
        readonly IDictionary<TKey, TValue> original;

        public RxDictionary(IDictionary<TKey, TValue> original)
        {
        ...
        /// </summary>
        RxDictionary<TKey, TValue> CountAndKeySetReactiveObject => this;
